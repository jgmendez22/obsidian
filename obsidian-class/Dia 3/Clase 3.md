...
Configuracion de Teachable Machine con muestras de imagenes

![[2.png]]

Utilizamos nuestro celular conectándolo con Ivcam, de esta forma nos grabábamos desde el celular y la imagen se reflejaba en el computador

![[3.png]]



EJERCIO FINAL DEL TERCER DIA!!!!



El programa a realizar se basara en la probabilidad que un pasajero del Titanic  de que pueda o pudo sobrevivir a este gran desastre: 
